...
import com.tbane.bubble_shooter.Game.Game;
...
import com.tbane.bubble_shooter.GUI.ButtonWithText;
...
public class MainMenu extends Layout {
    ...
    public MainMenu() {
        ...
        _buttons.get(0).onclick_func = () -> {
            ...
            LayoutsManager.layouts.add(new Game());
        };

        _buttons.get(1).onclick_func = () -> LayoutsManager.layouts.add(new Highscores());

        _buttons.get(2).onclick_func = () -> LayoutsManager.layouts.add(new Instructions());

        _buttons.get(3).onclick_func = () -> LayoutsManager.layouts.add(new About());
